...
class Ziraat extends DriverAbstract
{
    ...
    {
        $this->clientid = config('lydiapay.drivers.ziraat.clientid');
        $this->ok_url = config('lydiapay.drivers.ziraat.ok_url');
        $this->fail_url = config('lydiapay.drivers.ziraat.fail_url');
        $this->storetype = config('lydiapay.drivers.ziraat.storetype');
        $this->storekey = config('lydiapay.drivers.ziraat.storekey');
        $this->pay_url = config('lydiapay.drivers.ziraat.pay_url');
    }
